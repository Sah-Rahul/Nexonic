...
import smarthome from "../AlllJsonData/SmartHome/Smarthome.json";
...
const HomeSmart = () => {
  ...
  const totalPages = Math.ceil(smarthome.length / itemsPerPage);
  const indexOfLastItem = currentPage * itemsPerPage;
  const indexOfFirstItem = indexOfLastItem - itemsPerPage;
  const currentItems = smarthome.slice(indexOfFirstItem, indexOfLastItem);
    ...
    <Layout>
      <div className="min-h-screen   mt-5 w-[94%] p-4">
        ...
        <h1 className="mb-5 text-black">
          Make your home smarter with our range of smart devices. From
          voice-controlled lights to automated security systems, bring comfort,
          control, and security into your hands with our latest smart home
          solutions
        </h1>
