...
const HomeAppliances = () => {
  ...
  const totalPages = Math.ceil(homeAppliances.length / itemsPerPage);
  const indexOfLastItem = currentPage * itemsPerPage;
  const indexOfFirstItem = indexOfLastItem - itemsPerPage;
  const currentItems = homeAppliances.slice(indexOfFirstItem, indexOfLastItem);
    ...
    <Layout>
      <div className="min-h-screen   mt-5 w-[94%] p-4">
        ...
        <h1 className="mb-5 text-black">
          Upgrade your lifestyle with our wide range of home appliances designed
          to add convenience and comfort to your daily routine. From smart
          kitchen tools to essential cleaning gadgets, we bring you reliable and
          energy-efficient solutions for every corner of your home.
        </h1>
