    ...
    <Layout>
      <div className="min-h-screen   mt-5 w-[94%] p-4">
        ...
        <h1 className="mb-5 text-black">
          Stay ahead of the tech curve with our trending gadgets. Whether it's wearable tech, portable chargers, or innovative tools, we have everything a modern lifestyle demands — stylish, compact, and high-performance.
        </h1>
