    ...
    <Layout>
      <div className="min-h-screen   mt-5 w-[94%] p-4">
        ...
        <h1 className="mb-5 text-black">
          Discover the latest in technology and innovation with our new arrivals
          section. Be the first to shop cutting-edge appliances, electronics,
          and smart home devices freshly added to our collection.
        </h1>
