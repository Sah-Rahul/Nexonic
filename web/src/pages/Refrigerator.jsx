    ...
    <Layout>
      <div className="min-h-screen   mt-5 w-[94%] p-4">
        ...
        <h1 className="mb-5 text-black">
          Keep your food fresh and organized with our advanced refrigerators. Choose from single door, double door, side-by-side, and smart refrigerators with features like inverter technology, fast cooling, and energy efficiency.
        </h1>
