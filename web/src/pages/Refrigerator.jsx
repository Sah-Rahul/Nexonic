...
const Refrigerator = () => {
  ...
  const totalPages = Math.ceil(refrigerator.length / itemsPerPage);
  const indexOfLastItem = currentPage * itemsPerPage;
  const indexOfFirstItem = indexOfLastItem - itemsPerPage;
  const currentItems = refrigerator.slice(indexOfFirstItem, indexOfLastItem);
