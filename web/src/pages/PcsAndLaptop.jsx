...
const PcsAndLaptop = () => {
  ...
  const totalPages = Math.ceil(pcAndLaptop.length / itemsPerPage);
  const indexOfLastItem = currentPage * itemsPerPage;
  const indexOfFirstItem = indexOfLastItem - itemsPerPage;
  const currentItems = pcAndLaptop.slice(indexOfFirstItem, indexOfLastItem);
    ...
    <Layout>
      <div className="min-h-screen   mt-5 w-[94%] p-4">
        ...
        <h1 className="mb-5 text-black">
          Boost your productivity and entertainment with our collection of PCs
          and laptops. Choose from top brands, high-performance machines, and
          budget-friendly options tailored for work, gaming, and study.
        </h1>
