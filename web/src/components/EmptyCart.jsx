...
const EmptyCart = () => {
  ...
  return (
    <div className="text-center py-12">
      ...
      <Link to={"/products"}>
        <button
          className="mt-8 px-8 py-3 bg-gradient-to-r from-blue-500 to-teal-500 text-white rounded-full cursor-pointer font-semibold hover:from-blue-600 hover:to-teal-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl animate-fade-in"
