...
const Customize: React.FC<CustomizeProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div
        className={`h-full w-[355px] fixed top-0 right-0 z-999 bg-white shadow-lg transform transition-transform duration-300 ease-in-out ${
