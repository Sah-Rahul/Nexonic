...
import refrigerator from "../AlllJsonData/Refrigerator/Refrigerator.json";
    ...
    <Layout>
      <div className="min-h-screen mt-5 w-[94%] p-4">
        ...
        <h1 className="mb-5 text-black">
          Keep your food fresh and organized with our advanced refrigerators.
          Choose from single door, double door, side-by-side, and smart
          refrigerators with features like inverter technology, fast cooling,
        ...
        <div className="relative p-5 bg-white flex flex-wrap justify-between mt-5">
          {(refrigerator as RefrigeratorItem[]).map((item) => (
            <div
              key={item.id}
              data-aos="fade-up"
        ...
        <div className="flex items-center flex-row-reverse gap-4 py-8 mt-8">
          <button
            style={{ background: themeColor }}
            className="px-4 py-2 cursor-pointer rounded-lg font-medium transition-all duration-300 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
          >
