              ...
              {giftCategories.map((category, index) => (
                ...
                >
                  <div className="relative h-64 md:h-80 overflow-hidden">
                    ...
                    <div
                      className={`absolute inset-0 bg-gradient-to- ${category.color} opacity-0 group-hover:opacity-60 transition-opacity duration-500`}
                    ></div>

                    <div className="absolute inset-0 flex flex-col justify-end p-6 bg-gradient-to- from-black/80 via-black/40 to-transparent">
